        ...
        <div className="">
          ...
          <div className="mt-2">
            <h1 className="text-2xl font-medium">
              Rating : <span className="text-2xl text-teal-500">{rating}</span>{" "}
            </h1>
          </div>
        </div>
        <div className="w-6/12 mx-2 mt-4">
            <img src="https://w0.peakpx.com/wallpaper/620/932/HD-wallpaper-ulysses-nardin-blue-clock-clocks-fossil-luxury-rotary-watch-watches-zenith-thumbnail.jpg" className="rounded-lg" alt="" />
        </div>
      </div>
    </div>
  );
